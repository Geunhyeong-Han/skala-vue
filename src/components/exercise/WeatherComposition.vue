...
const weatherList = ref([
  {
    ...
    tourism: {
      hot: {
        label: '🌊 한강 물놀이 시즌',
        detail:
          '한강공원 반포 무지개분수와 물놀이장에서 더위를 식히고, 야간 한강 피크닉을 즐기기 추천.',
      },
      mild: {
        label: '🚶 고궁 도보여행',
        detail: '경복궁·북촌한옥마을 도보 여행과 남산타워 야경 감상하기 좋은 날씨예요.',
      },
      cool: {
        label: '🏛️ 실내 전시 관람',
        detail: '광장시장 먹거리 투어와 국립중앙박물관 등 실내 전시 관람을 추천해요.',
      },
    },
  },
  {
    ...
    tourism: {
      hot: {
        label: '🏖️ 해수욕장 피서',
        detail:
          '해운대·광안리 해수욕장에서 물놀이를 즐기고, 화려한 광안대교 야경으로 여름밤을 즐겨보세요.',
      },
      mild: {
        label: '🎨 문화마을 산책',
        detail: '감천문화마을과 태종대를 산책하기 좋은 선선한 날씨예요.',
      },
      cool: {
        label: '🐠 아쿠아리움 나들이',
        detail: '부산아쿠아리움, 온천천 스파 등 실내 관광지를 추천해요.',
      },
    },
  },
  {
    ...
    tourism: {
      hot: {
        label: '🏄 서핑 & 해변',
        detail:
          '안목 해변 서핑과 경포해변 물놀이를 즐기고, 시원한 카페거리에서 커피 한 잔 즐겨보세요.',
      },
      mild: {
        label: '☕ 카페거리 산책',
        detail: '안목 카페거리 산책과 하슬라아트월드 미술 감상하기 좋은 날씨예요.',
      },
      cool: {
        label: '🌅 일출 명소 투어',
        detail: '정동진 일출 명소와 오죽헌 등 관광지를 둘러보기 좋아요.',
      },
    },
  },
  {
    ...
    tourism: {
      hot: {
        label: '🌊 해변 일몰 감상',
        detail: '곽지·협재 해수욕장에서 물놀이를 즐기고 환상적인 일몰을 감상해보세요.',
      },
      mild: { label: '🥾 오름 트레킹', detail: '한라산 둘레길과 오름 트레킹하기 좋은 날씨예요.' },
      cool: {
        label: '☕ 실내 박물관 투어',
        detail: '표선해변 인근 실내 박물관과 카페 투어를 추천해요.',
      },
    },
  },
  {
    ...
    tourism: {
      hot: {
        label: '🏯 유적지 관람 후 호수 산책',
        detail: '불국사·석굴암을 관람한 뒤, 보문호 주변에서 시원하게 쉬어가기 좋아요.',
      },
      mild: {
        label: '🚶 신라 유적 도보여행',
        detail: '양동마을과 첨성대 등 신라 유적을 도보로 여행하기 좋은 날씨예요.',
      },
      cool: {
        label: '🏛️ 실내 박물관 관람',
        detail: '국립경주박물관 등 실내 전시 관람을 추천해요.',
      },
    },
  },
])
...
watch(selectedCityId, (newId) => {
  if (!newId) return
  console.log(
    `👁️‍🗨️ [watch 감지] 선택 도시 변경 -> "${selectedCity.value?.name}" (${selectedTourism.value?.label})`,
  )
})
  ...
  <div class="dashboard-wrapper">
    ...
    <section class="list-box">
      ...
      >
        ...
        <p class="tourism-info">
          관광 특성: <strong>{{ tourismLabel(item) }}</strong>
        </p>
